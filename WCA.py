...
echo $yellow
figlet -f future "Wolf Cyber Army"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Chemod@rakhagabs"$cyan" ~/WolfCyber"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Chemod@Rakhagans"$cyan" ~/WolfCyber"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Chemod@Rakhagans"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Chemod@Rakhagans"$cyan" ~/WolfCyber"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"Chemod@Rakhagans"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $white "╭─"$green"Chemod@Rakhagand"$cyan" ~/Crot"$white
read -p " ╰─$ " target8
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : ./RakhaGans07			"
echo $purple"Gthub   : https://github.com/wolfcybe99"
echo $white"Blog    : http://wolfcyberarmy22.blogspot.com"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] J1N AND MR.Z "
echo $cyan"[+] NOBITA, KUCHENG, HELIX, VIP CEWE GAMER, MI.SETYA, HAKADIV, KRISTIAN, RUSLI "
echo $cyan"[+] YUJ1NKUN404 & All Member [W.C.A] "
echo $red"##########################$green" WELCOME "$red###########################"
